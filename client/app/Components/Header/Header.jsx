...
const Header = () => {
  ...
  return (
    <>
      <nav className="bg-opacity-0  w-full md:fixed  z-10 " id="nav">
        ...
        <div
          className="w-full h-1 bg-gradient-to-r from-black via-red-600  via-red-600 via-red-600 to-black md:hidden"
          id="linha"
        ></div>
        {isClick && (
          <motion.div
